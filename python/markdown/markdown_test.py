...
class MarkdownTest(unittest.TestCase):
    ...
    def test_h1(self):
        self.assertEqual(
            parse_markdown("# This will be an h1"), "<h1>This will be an h1</h1>"
        )

    def test_h2(self):
        self.assertEqual(
            parse_markdown("## This will be an h2"), "<h2>This will be an h2</h2>"
        )

    def test_h6(self):
        self.assertEqual(
            parse_markdown("###### This will be an h6"), "<h6>This will be an h6</h6>"
        )
    ...
    def test_symbols_in_the_list_item_text_that_should_not_be_interpreted(self):
        self.assertEqual(
            parse_markdown(
    ...
    def test_symbols_in_the_paragraph_text_that_should_not_be_interpreted(self):
        self.assertEqual(
